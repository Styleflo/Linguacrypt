...
- Avancés sur les vues utilisateur, l'utilisateur peut : 
        ...
        - S'il appuie sur Jouer, il arrive sur une superbe page de jeu ou il voit un plateau de 5*5 cartes et ou il peut jouer ! Quand il clique sur les cartes, leur couleur se révèle ce qui met à jour des petits compteurs. Si les joueurs se trompent de carte, le tour passe directement. 
