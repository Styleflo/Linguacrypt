...
- Avancés sur la construction des Classes Jeu, Plateau, Cartes qui construisent la logique du jeu. (Hippo et Flo)

- Avancés sur les differentes vue utilisateur, l'utilisateur peut : 
...
- Avancés sur les vues utilisateur, l'utilisateur peut : 
        ...
        - Ouvrir l'application, il arrive sur un Menu avec le nom du jeu.
        - Du Menu, il peut choisir de cliquer sur 2 boutons : Cartes, Jouer et Quitter. 
        - S'il appuie sur Cartes, il arrive sur une page pour visualiser les cartes, il peut naviguer entre les differentes catégories pour regarder toutes les cartes avec les boutons "Thème précédent" et "Thème suivant". 
        ...
        - S'il appuie sur Jouer, il arrive sur une superbe page de jeu ou il voit un plateau de 5*5 cartes et ou il peut jouer ! Quand il clique sur les cartes, leur couleur se révèle ce qui met à jour des petits compteur. 
...
- Quelques tests de mis en place. 
